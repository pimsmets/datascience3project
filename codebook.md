...
The data set produced by this script summarizes the original data as follows :

All the variables describing a mean or a standard deviation are averaged per subject and per activity.
The resulting data set thus contains 180 rows (30 subject x 6 activities).
